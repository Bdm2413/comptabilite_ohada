    ...
    <nav class="flex-1 overflow-y-auto px-2 py-2 space-y-0.5 text-xs">
        ...
        <?php accordionBtn('fournisseurs',
            ...
            <?php navLink("$basePath/achats/bons_commande.php",
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>',
                'BC fournisseurs', isActiveMultiple(['bons_commande.php','bc_form.php'], 'achats')
            ); ?>
        ...
        <?php accordionBtn('analyses',
            ...
            <?php navLink("$basePath/rapports/grand_livre.php",
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>',
                'Grand Livre', isActive('grand_livre.php', 'rapports')
            ); ?>
            <?php navLink("$basePath/rapports/journal_general.php",
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>',
                'Journal Général', isActive('journal_general.php', 'rapports')
            ); ?>
            <?php navLink("$basePath/rapports/balance_generale.php",
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>',
                'Balance Générale', isActive('balance_generale.php', 'rapports')
            ); ?>
            <?php navLink("$basePath/rapports/balance_auxiliaire.php",
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16"/>',
                'Balance Auxiliaire', isActive('balance_auxiliaire.php', 'rapports')
            ); ?>
            <?php navLink("$basePath/analyses/heatmap.php",
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"/>',
                'Heatmap', isActive('heatmap.php', 'analyses')
            ); ?>
            <?php navLink("$basePath/analyses/comparaison.php",
                '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>',
                'Comparaison', isActive('comparaison.php', 'analyses')
            ); ?>
        <?php endAccordion(); ?>
        ...
        <?php accordionBtn('parametres',
            ...
            <?php navLink("$basePath/settings/exercices.php", '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>', 'Gestion périodes', isActive('exercices.php', 'settings')); ?>
            ...
            <?php navLink("$basePath/settings/catalogue.php", '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>', 'Catalogue', isActive('catalogue.php', 'settings')); ?>
