    ...
    <nav class="flex-1 overflow-y-auto p-2 space-y-0.5">
        ...
        <div class="pt-1.5">
            ...
            <div id="accordion-parametres" class="hidden mt-0.5 ml-2 space-y-0.5">
                ...
                <a href="<?php echo $basePath; ?>/settings/totp_setup.php" class="flex items-center gap-2 px-2 py-1.5 <?php echo isActive('totp_setup.php'); ?> rounded-lg text-xs transition">
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
